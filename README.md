...
>
```text
Install and configure Nexus. You MUST read AGENTS.md first and use your interaction tool (e.g., ask_user, input) to let me choose the installation method BEFORE executing any other commands.
https://raw.githubusercontent.com/yohi/nexus/refs/heads/master/README.md
https://raw.githubusercontent.com/yohi/nexus/refs/heads/master/AGENTS.md
```
<details>
