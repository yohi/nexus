...
- [x] **Step 1: 既存のテストがパスすることを確認する（警告が出る可能性がある）**

Run: `npx vitest tests/unit/indexer/dead-letter-queue.test.ts`

- [x] **Step 2: stopFirst() および stop1() の呼び出しに await を追加する**
...
- [x] **Step 1: 相対パスインポートをパッケージ名またはプレースホルダーに変更する**
